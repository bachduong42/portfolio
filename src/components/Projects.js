...
function Projects() {
    const listProject = [
        { ava: tiktok, name: 'TikTok Clone', descrip: 'Replicates a short video platform similar to TikTok. It features video uploads, user interactions (like,comment, follow), and user management.', link: 'https://tiktok-eight-flame.vercel.app/' },
